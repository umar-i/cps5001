...
final class PerdsControllerRouteInvalidationTest {
    @Test
    void cancelsAndReassignsWhenAssignedRouteBecomesInvalid() {
        ...
        controller.execute(new SystemCommand.UpdateEdgeCommand(b, c, fast, EdgeStatus.CLOSED), t1);
        ...
        assertEquals(java.util.List.of(a, c), reassigned.route().nodes());
    }
}
